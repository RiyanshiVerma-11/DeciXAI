export default function StepReview({ data, onChange, setStep }) {
  return (
    <div className="space-y-4">
      ...
      <div className="flex gap-3">
        ...
        <button className="rounded bg-blue-600 px-4 py-2 text-white" onClick={() => onChange({ submitted: true })}>Submit</button>
      </div>
    </div>
  );
}
